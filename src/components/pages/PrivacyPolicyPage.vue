<template>
  <div class="wrapper">
    ...
    <p>
      At 3s-trading.com, accessible from wtrading.org, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by
      wtrading.org and how we use it.
    </p>
    <p>
    ...
    <h3>LOG FILES</h3>
    <p>
      3s-trading.com follows a standard procedure of using log files. These
    ...
    <p>
      Like any other website, 3s-trading.com uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of 3s-trading.com.Third-party ad servers or ad
      ...
      wtrading.org, which are sent directly to users' browser. They
      ...
      that you visit. Note that 3s-trading.com has no access to or control over
      these cookies that are used by third-party advertisers.
    </p>
    <h3>THIRD PARTY PRIVACY POLICIES</h3>
    <p>
      3s-trading.com Privacy Policy does not apply to other advertisers or
